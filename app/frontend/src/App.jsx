...
const LABELS = {
  en: {
    ...
    genericError: 'Something went wrong talking to the AI. This is often a temporary rate limit — wait a moment and try again.',
  ...
  or: {
    ...
    episodeLabel: 'ପର୍ବ',
    genericError: 'AI ସହିତ କଥାବାର୍ତ୍ତାରେ ଏକ ତ୍ରୁଟି ହେଲା। ଏହା ସାଧାରଣତଃ ଅସ୍ଥାୟୀ ରେଟ୍ ଲିମିଟ୍ - ଅଳ୍ପ ସମୟ ଅପେକ୍ଷା କରି ପୁନଃ ଚେଷ୍ଟା କରନ୍ତୁ।',
